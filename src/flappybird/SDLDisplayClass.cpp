...
size_t SDLDisplayClass::addEntity(ECS::Utils::Vector2f aPos, Component::Speed aSpeed, Component::Weight aWeight,
                                  Component::TypeEntity aType, Component::LoadedSprite aSprite, Component::Jump aJump)
{
    ...
    weight.insertAt(idx, aWeight);
    type.insertAt(idx, aType);
    sprite.insertAt(idx, aSprite);
    jump.insertAt(idx, aJump);
    return idx;
}
