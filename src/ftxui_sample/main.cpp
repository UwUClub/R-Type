...
// configuration step. It creates a namespace called `R_Type`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", R_Type::cmake::project_name, R_Type::cmake::project_version) };
