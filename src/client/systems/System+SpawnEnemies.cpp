...
namespace ECS {
    void System::spawnEnemies(Core::SparseArray<Utils::Vector2f> &aPos,
                              ...
                              Core::SparseArray<Component::LoadedSprite> &aSprites)
    {
        ...
        display.addEntity(
        ECS::Utils::Vector2f {static_cast<float>(SCREEN_WIDTH - 30), static_cast<float>(rand()%SCREEN_HEIGHT)}, Component::Speed {20},
        Component::TypeEntity {false, true, false, false, false, false},
