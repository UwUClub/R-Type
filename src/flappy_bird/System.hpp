...
namespace ECS {
    class System
    {
        public:
             ...
             */
            static void applyGravity(Core::World &aWorld, Core::SparseArray<ECS::Utils::Vector2f> &aPos,
                                     Core::SparseArray<ECS::Utils::Weight> &aWeight,
             ...
             * @param aType SparseArray of all entities type
             */
            static void jump(Core::World &aWorld, Core::SparseArray<ECS::Utils::Vector2f> &aPos,
                             Core::SparseArray<ECS::Utils::Jump> &aJump,
                             Core::SparseArray<ECS::Utils::TypeEntity> &aType);
